...
document.addEventListener('DOMContentLoaded', () => {
  ...
  click('btn-slide-prompt', () => {
    showScreen('slide');
    initSlidePrompt();
  });
  click('btn-back', () => showScreen('main'));

  click('btn-refresh', refreshStats);
  click('btn-export', exportData);
  click('btn-import', () => byId('import-file').click());
  on('import-file', 'change', importData);
  click('btn-open-notebooklm', openNotebookLM);
  click('btn-reset', resetData);
  ...
  click('btn-add-color', showAddColorForm);
  click('btn-save-color', saveCustomColor);
  click('btn-cancel-color', hideAddColorForm);

  click('btn-save-preset', showSavePresetForm);
  click('btn-confirm-save-preset', savePreset);
  click('btn-cancel-save-preset', hideSavePresetForm);

  click('btn-copy-prompt', copyPrompt);
...
function showScreen(screenName) {
  ...
  if (screenName === 'main') {
    ...
    headerTitle.textContent = 'FolderLM';
  } else {
    backBtn.classList.add('visible');
    headerTitle.textContent = 'Slide Prompt Builder';
  }
}
...
async function importData(event) {
  ...
  try {
    ...
    showMessage('Data imported. Please reload the page.', 'success');
    loadStats();
  } catch {
...
function updateColorSelectOptions(colors) {
  ['main-color', 'accent-color', 'bg-color'].forEach((selectId) => {
    const select = document.getElementById(selectId);
...
function showMessage(text, type = 'info') {
  ...
  messageEl.className = `sp-message ${type}`;
